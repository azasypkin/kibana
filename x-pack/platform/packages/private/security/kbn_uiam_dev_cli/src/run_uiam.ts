...
const ENV_DEFAULTS = {
  ...
  // Taken from Serverless GitOps version file for UIAM service (dev env, services/uiam/versions.yaml)
  UIAM_GIT_REVISION: 'git-da837a8df89e',
  UIAM_LOGGING_LEVEL: 'DEBUG',
};
...
#   entrypoint: ["tail", "-f", "/dev/null"] # Hack to keep the container running for debugging purposes
    environment:
